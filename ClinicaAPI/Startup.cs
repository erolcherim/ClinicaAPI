    ...
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddSwaggerGen(c =>
            {
                ...
                c.SwaggerDoc("v1", new OpenApiInfo { Title = "ClinicaAPI", Version = "v1" });
            });
            ...
            services.AddTransient<IClientOfferLocationRepository, ClientOfferLocationRepository>();
        ...
        public void Configure(IApplicationBuilder app, InitialSeed initialSeed, IWebHostEnvironment env)
        {
            if (env.IsDevelopment())
            {
                ...
                app.UseSwagger();
                app.UseSwaggerUI(c => c.SwaggerEndpoint("/swagger/v1/swagger.json", "ClinicaAPI v1"));
            }
